...
//{
	...
	draw_sprite(spr_collisionchar,0,x,y + z);							// Show the Player's collision box
	...
	draw_text(x, y + 15, "vx: " + string(vx));		// Show the name of the actual state 
	draw_text(x, y + 25, "vy: " + string(vy));		// Show the name of the actual state 
	draw_text(x, y + 35, "vz: " + string(vz));		// Show the name of the actual state 
