...
//         sprite_index = asset_get_index("sPlayer" + playerId + "Idle");		// asset_get_index() can load an sprite from an string. So here we play the sprite animation sPlayer1Idle (or sPlayer1Idle, depending on playerId)
//     break;
    
//     case RUN: 
//         image_speed = global.animFPS/2; 
//         sprite_index = asset_get_index("sPlayer" + playerId + "Run");
//     break;
...
//             sprite_index = asset_get_index("sPlayer" + playerId + "Jump");										// The rising up animation...
//         else
//             sprite_index = asset_get_index("sPlayer" + playerId + "Fall");										// ...and the falling one
